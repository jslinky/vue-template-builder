    ...
    <div class="c-container-buttons o-container" style="text-align:center">
      ...
      <div class="o-buttons o-buttons--grouped add-remove-buttons">
        <CustomButton
          ...
          basic
          :class="{'inverted': invert, 'add-remove-buttons-btn': true, 'disabled':modules.buttons.content.length == this.modules.buttons.content.min}"
        ...
        <CustomButton
          ...
          :class="{'inverted': invert, 'add-remove-buttons-btn': true, 'disabled':modules.buttons.content.length == modules.buttons.content.max}"
          style="margin-top:1rem"
        >
          <svg class="o-btn__icon">
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#chevronRightLight"></use>
      ...
      <ModuleComponent :ref="modules.buttons.name" :module="modules.buttons">
        ...
        >Oh dear, I'm empty</CustomHeader>
        <CustomButton
          basic
          :class="{'inverted': invert}"
          v-for="button in modules.buttons.content.length"
        >Button</CustomButton>
      </ModuleComponent>
    </div>
  </div>
