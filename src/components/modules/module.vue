...
export default {
  ...
  methods: {
    getHtml() {
      let htmlContent;
      htmlContent =
        this.module.classes.default.length > 0
          ? this.$refs[this.module.name].outerHTML
          : this.$refs[this.module.name].innerHTML;
  ...
  computed: {
    ...
    classesAvailable() {
      return this.module.classes.available;
    },
    classesApplied() {
      return this.module.classes.applied;
    },
    debugStyles() {
    ...
    moduleHtml() {
      return this.module.html.content;
    }
  },
  watch: {
