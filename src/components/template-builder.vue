...
export default {
  ...
  mounted() {
    ...
    this.$http.get('https://api.flickr.com/services/feeds/photos_public.gne?jsoncallback&tags=fashion&format=json', { 'Accept': 'application/json', 'Access-Control-Allow-Origin': '*' })
          .then(response => (console.log(response))).catch(e => console.log("ERROR MSG " + e))
  }  
}
