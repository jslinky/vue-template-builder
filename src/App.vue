  ...
  <div id="app">
    ...
    <div class="main-nav">
      <div v-if="activeComponent != 'templateBuilder'">
        ...
        <a class="o-btn" data-ref="container" @click="switchComponent($event)">Container</a>
        ...
        <a class="o-btn" data-ref="templateBuilder" @click="switchComponent($event)">Template Builder</a>
      </div>
      <div v-else>
